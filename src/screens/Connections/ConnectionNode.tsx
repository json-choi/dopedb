  ...
  return (
    <div className="tw:relative">
      <div
        ...
        className="ds-object-row tw:group tw:relative tw:h-control-sm tw:min-h-control-sm tw:cursor-grab tw:touch-none tw:select-none tw:py-0 tw:pr-[calc(var(--ds-control-xs)+var(--ds-space-1))] tw:text-sm tw:font-normal tw:leading-ui tw:active:cursor-grabbing tw:data-[nested=true]:pl-2 tw:data-[dragging=true]:opacity-50 tw:data-[drop-target=true]:bg-muted tw:data-[drop-target=true]:ring-2 tw:data-[drop-target=true]:ring-ring"
        role="treeitem"
      ...
      >
        ...
        <div
          className="db-menu tw:pointer-events-none tw:absolute tw:top-1/2 tw:right-1 tw:flex tw:-translate-y-1/2 tw:items-center tw:bg-background tw:opacity-0 tw:transition-opacity tw:group-hover:pointer-events-auto tw:group-hover:opacity-100 tw:group-focus-within:pointer-events-auto tw:group-focus-within:opacity-100 tw:focus-within:pointer-events-auto tw:focus-within:opacity-100 tw:data-[open=true]:pointer-events-auto tw:data-[open=true]:z-[var(--ds-z-popover)] tw:data-[open=true]:opacity-100"
