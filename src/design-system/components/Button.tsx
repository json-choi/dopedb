...
type DisabledActivationEvent = {
  preventDefault: () => void;
  stopPropagation: () => void;
};

function blockFocusableDisabledActivation(
  event: DisabledActivationEvent,
  key?: string,
) {
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const focusableDisabled = disabled && disabledBehavior === "focusable";
  const tooltipLabel =
  ...
  const button = (
    <button
      ...
      aria-disabled={focusableDisabled ? true : ariaDisabled}
      disabled={disabled && !focusableDisabled}
