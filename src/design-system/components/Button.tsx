...
// aria-disabled keeps the button focusable for a screen reader and for the
// keyboard user who just pressed it, so the primitive also blocks the pointer,
// Enter and Space activation that attribute only announces.
...
> & {
  ...
  labelBehavior?: "nowrap" | "wrap";
  presentation?: "button" | "listItem" | "menuItem";
