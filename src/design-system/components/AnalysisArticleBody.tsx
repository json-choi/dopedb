...
// Preserve the sanitized DOM across outline and run-state updates; replacing it
// would invalidate the reader's observed heading elements and keyboard focus.
export const AnalysisArticleBody = memo(forwardRef<HTMLDivElement, { html: string }>(function AnalysisArticleBody({ html }, ref) {
  return (
    <div
      ref={ref}
