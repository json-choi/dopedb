...
export const sqlCatalog = defineCatalog(
  {
    ...
    "sql.openSavedQuery": "Open saved query",
  ...
  },
  {
    ...
    "sql.explain": "실행 계획",
    "sql.explainReadOnly": "실행 계획은 읽기 문장용입니다. 쓰기 영향 미리보기는 실행에서 확인하세요.",
    "sql.explainSingle": "실행 계획은 단일 문장에서만 확인할 수 있습니다",
