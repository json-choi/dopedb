...
export const agentsCatalog = defineCatalog(
  {
    ...
    "agent.acpApprovalDefault": "Ask each time",
    "agent.acpApprovalEdits": "Accept edits",
    "agent.acpApprovalPlan": "Plan only",
    "agent.acpApprovalAuto": "Claude decides",
    "agent.acpApprovalBypass": "Auto approve",
    "agent.acpApprovalAgentDecides": "Agent decides",
    "agent.acpApprovalFullAccess": "Full access · auto approve",
    "agent.acpApprovalDefaultShort": "Ask",
    "agent.acpApprovalEditsShort": "Edits",
    "agent.acpApprovalPlanShort": "Plan",
    "agent.acpApprovalAutoShort": "Auto",
    "agent.acpApprovalFullShort": "Always allow",
    ...
    "agent.acpResourceCountsCompact": "{databases} DB · {sources} src",
    "agent.acpReadCompact": "Read",
    "agent.acpWriteCompact": "Write",
    ...
    "agent.acpActivityArticleGuide": "Reading the Article authoring guide",
    ...
    "agentTools.startupBody":
      "Choose the Agents you want to use in DopeDB. The app prepares each selected Agent and checks its local sign-in.",
    "agentTools.startupHeading": "Choose Agents for DopeDB",
    "agentTools.startupLater": "Later",
    "agentTools.startupSafety":
      "If an Agent is missing or signed out, finish setup with its official app. DopeDB never reads its login token.",
    "agentTools.startupInstallSelected": "Prepare selected Agents",
    "agentTools.startupInstalling": "Preparing Agents…",
    ...
    "agentTools.agentsTitle": "Agents",
    "agentTools.agentsDescription":
      "Choose an Agent to prepare it for AI Chat. Local installation and sign-in are checked in the same row.",
    "agentTools.agentPrepared": "Agent connection prepared.",
    "agentTools.agentReady": "Ready to chat",
    "agentTools.agentNotReady": "Setup needed",
    "agentTools.agentNotSelected": "Not selected",
    "agentTools.agentSetupFailed": "Setup failed",
    "agentTools.prepareAgent": "Prepare",
    "agentTools.useAgent": "Use",
    "agentTools.preparingAgent": "Preparing {provider}",
    "agentTools.setupGuide": "Setup guide",
    "agentTools.loginGuide": "Sign-in guide",
    "agentTools.agentDetails": "Installation details and external use",
    "agentTools.localRuntime": "Official Agent CLI",
    "agentTools.externalSkill": "DopeDB Skill",
    "agentTools.externalSkillDescription":
      "Optional guide for using DopeDB from this Agent outside the built-in chat.",
    "agentTools.connectionComponent": "Chat connection",
    "agentTools.advancedDiagnostics": "Advanced diagnostics",
    ...
    "agentTools.pluginsError": "Could not check Agent connections: {error}",
    "agentTools.pluginsInstalled": "Installed {count} ACP adapter plugin(s).",
    "agentTools.pluginRemoved": "Agent connection removed. Local login, Skill, and conversation history were preserved.",
    ...
    "agentTools.removePlugin": "Remove chat connection",
    "agentTools.removePluginConfirm":
      "Close active {provider} sessions and remove its chat connection? Local login and conversations are preserved.",
    ...
    "agentTools.pluginProgress": "Preparing {provider}",
  ...
  },
  {
    ...
    "agent.acpApprovalDefault": "매번 확인",
    "agent.acpApprovalEdits": "편집 자동 승인",
    "agent.acpApprovalPlan": "계획만",
    "agent.acpApprovalAuto": "Claude 자동 판단",
    "agent.acpApprovalBypass": "자동 승인",
    "agent.acpApprovalAgentDecides": "Agent가 판단",
    "agent.acpApprovalFullAccess": "전체 접근 · 항상 허용",
    "agent.acpApprovalDefaultShort": "매번 확인",
    "agent.acpApprovalEditsShort": "편집 허용",
    "agent.acpApprovalPlanShort": "계획만",
    "agent.acpApprovalAutoShort": "자동 판단",
    "agent.acpApprovalFullShort": "항상 허용",
    ...
    "agent.acpResourceCountsCompact": "DB {databases} · 소스 {sources}",
    "agent.acpReadCompact": "읽기",
    "agent.acpWriteCompact": "쓰기",
    "agent.acpCurrentResourceScope":
    ...
    "agent.acpActivityArticleGuide": "아티클 작성 가이드 확인",
    ...
    "agentTools.startupBody":
      "DopeDB에서 사용할 Agent를 선택하세요. 선택한 Agent의 채팅 연결을 준비하고 로컬 로그인 상태를 확인합니다.",
    "agentTools.startupHeading": "DopeDB에서 사용할 Agent 선택",
    "agentTools.startupLater": "나중에",
    "agentTools.startupSafety":
      "Agent가 없거나 로그아웃 상태라면 공식 앱에서 설정을 마쳐야 합니다. DopeDB는 로그인 토큰을 읽지 않습니다.",
    "agentTools.startupInstallSelected": "선택한 Agent 준비",
    "agentTools.startupInstalling": "Agent 준비 중…",
    ...
    "agentTools.agentsTitle": "사용할 에이전트",
    "agentTools.agentsDescription":
      "AI Chat에서 사용할 Agent를 선택하세요. 연결 준비와 로컬 로그인 상태를 한곳에서 확인합니다.",
    "agentTools.agentPrepared": "Agent 연결을 준비했습니다.",
    "agentTools.agentReady": "채팅 준비 완료",
    "agentTools.agentNotReady": "설정 필요",
    "agentTools.agentNotSelected": "사용 안 함",
    "agentTools.agentSetupFailed": "설정 실패",
    "agentTools.prepareAgent": "준비하기",
    "agentTools.useAgent": "사용하기",
    "agentTools.preparingAgent": "{provider} 준비 중",
    "agentTools.setupGuide": "설치 안내",
    "agentTools.loginGuide": "로그인 안내",
    "agentTools.agentDetails": "설치 정보와 외부 사용",
    "agentTools.localRuntime": "공식 Agent CLI",
    "agentTools.externalSkill": "DopeDB 스킬",
    "agentTools.externalSkillDescription":
      "내장 채팅 밖에서 이 Agent로 DopeDB를 사용할 때만 필요한 선택 기능입니다.",
    "agentTools.connectionComponent": "채팅 연결 구성 요소",
    "agentTools.advancedDiagnostics": "고급 진단",
    "agentTools.pluginsTitle": "ACP 어댑터 플러그인",
    "agentTools.pluginsDescription":
      "사용하는 Claude와 Codex 공식 어댑터만 설치합니다. DopeDB가 서명된 번들을 검증하고 내장 Node로 실행합니다.",
    "agentTools.pluginsError": "에이전트 연결 상태를 확인하지 못했습니다: {error}",
    "agentTools.pluginsInstalled": "ACP 어댑터 플러그인 {count}개를 설치했습니다.",
    "agentTools.pluginRemoved": "에이전트 채팅 연결을 제거했습니다. 로컬 로그인, 스킬과 대화 기록은 보존했습니다.",
    ...
    "agentTools.removePlugin": "채팅 연결 제거",
    "agentTools.removePluginConfirm":
      "활성 {provider} 세션을 닫고 채팅 연결을 제거할까요? 로컬 로그인과 대화 기록은 보존됩니다.",
    ...
    "agentTools.pluginProgress": "{provider} 준비 중",
    "agentTools.pluginStagedDescription":
