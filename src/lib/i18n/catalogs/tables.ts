...
export const tablesCatalog = defineCatalog(
  {
    ...
    "tables.decodeFailureRowBlocked": "Row action blocked: column {column} could not be decoded as {type}.",
    ...
    "tables.orderByExpressionPlaceholder": "created_at DESC",
  ...
  },
  {
    ...
    "tables.decodeFailureRowBlocked": "행 작업을 수행할 수 없음: {column}열을 {type}(으)로 디코딩하지 못했습니다.",
