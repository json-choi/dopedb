...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            features::analysis_articles::sharing_transport::article_sharing_command,
            features::analysis_articles::sharing_transport::create_article_invitation_command,
            features::analysis_articles::sharing_transport::revoke_article_invitation_command,
            features::analysis_articles::desktop_links::pending_article_link_command,
            features::analysis_articles::desktop_links::dismiss_article_link_command,
